...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'L', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'Researcher & Programmer.', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://notion-next-1dt5eafzv-stan7s.vercel.app/', // 网站地址
